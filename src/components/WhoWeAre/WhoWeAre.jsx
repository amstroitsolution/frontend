...
const WhoWeAre = () => {
  const cards = [
    {
      icon: <FaPaintBrush style={{color: '#de3cad'}} className="text-5xl mb-4" />,
      title: "Quality",
      text: "We believe in upholding the highest standards of quality in everything we do we use to the techniques we employ.",
    },
    {
      icon: <FaHandsHelping style={{color: '#de3cad'}} className="text-5xl mb-4" />,
      title: "Craftsmanship",
    ...
    {
      icon: <FaSmile style={{color: '#de3cad'}} className="text-5xl mb-4" />,
  ...
  return (
    <section className="relative bg-gray-50 py-16 px-6 md:px-12 lg:px-24">
      ...
      <div className="relative text-center mb-12">
        <h3 style={{color: '#de3cad'}} className="font-semibold tracking-wide uppercase mb-2">
          Who We Are
        </h3>
      ...
      <div className="relative text-center mt-12">
        <button style={{background: 'linear-gradient(135deg, #de3cad, #e854c1)'}} className="px-6 py-3 text-white font-medium rounded-lg hover:opacity-90 transition-all duration-300 shadow-lg">
          View All Products
        </button>
      </div>
    </section>
