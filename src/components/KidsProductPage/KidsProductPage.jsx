...
const KidsProductPage = ({ 
  ...
  title, 
  description,
  gender = null // "Boys", "Girls", or null for all
}) => {
  ...
  return (
    <div className="bg-gradient-to-b from-pink-50 via-white to-purple-100 min-h-screen py-20 px-6">
      {/* Hero Header */}
      <motion.div
      ...
      {selectedForView && (
        ...
        >
          ...
          >
            ...
            {selectedForView.gender && (
              <p className="text-sm text-gray-500 mb-4 text-center">
                For: {selectedForView.gender}
              </p>
            )}
            <div className="flex flex-col gap-3">
              <button
